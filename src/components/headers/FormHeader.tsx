  ...
  return (
    <View>
      {activeTab === FormStep.TripDetails ? (
        ...
        <View className='flex flex-row items-center justify-between px-5 py-3'>
          <IconButton size={IconSize.Small} icon='ChevronLeftIcon' colour='#F9F8FF' bgClass='bg-none' onPress={() => setActiveTab(FormStep.TripFindLocation)}/>
        ...
        <View className='flex flex-row items-center justify-between px-5 py-3'>
          <IconButton size={IconSize.Small} icon='XMarkIcon' colour='#F9F8FF' bgClass='bg-none' onPress={() => setActiveTab(FormStep.TripAddLocation)}/>
